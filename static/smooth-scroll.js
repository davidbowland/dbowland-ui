...
var smoothScroll = new (function () {
  var self = this,
    ...
    start_x,
    start_y, // Starting viewport top left
    end_x,
    end_y, // Ending viewport top left
  ...
  self.scrollToCoord = function (x, y, options) {
    ...
    currentOptions = {
      duration: Math.ceil(Math.max(options.duration || defaultOptions.duration, 10) / step) * step,
      step: step,
